...
public class Strings
{
    ...
    /**
     * Splits the given string on the given token. Follows the semantics of the Java 1.4 {@link String#split(String,int)} method, but does not treat the given token as a regular
     * expression.
     */
