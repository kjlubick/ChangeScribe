...
/**
 * <p>
 * Lock implementation. The lock is aware of the thread that owns it, and allows that thread to {@link #lock} multiple times without blocking. Only the owning thread can
 * {@link #unlock}, and the lock will not be released to other threads until {@link #unlock} has been called the same number of times as {@link #lock}.
 * </p>
 *
 * <p>
 * Using this lock is similar to synchronizing on an object, but is more flexible (for example, the calls to {@link #lock} and {@link #unlock} can be surrounded by if statements).
 * </p>
 *
 * <p>
        ...
        implements Serializable
{
     ...
     *             if current thread is not owner
     */
