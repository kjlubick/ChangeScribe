...
/**
 * <p>
 * Pool implementation using object identity to maintain unique instances. Taken instances are held weakly, so there is not an absolute requirement that all taken instances be
 * manually returned to the pool.
 * </p>
 *
 * @author Abe White
 */
