...
/**
 * <p>
 * Map implementation in which the keys are held as weak references.
 * </p>
 *
 * <p>
 * Expired values are removed from the map before any mutator methods; removing before accessor methods can lead to {@link ConcurrentModificationException}s. Thus, the following
        ...
        extends RefKeyMap
{
    ...
    /**
     * Construct a WeakKeyMap with the given interal map. The internal map will be cleared. It should not be accessed in any way after being given to this constructor; this Map
     * will 'inherit' its behavior, however. For example, if the given map is a {@link LinkedHashMap}, the <code>values</code> method of this map will return values in insertion
     * order.
     */
