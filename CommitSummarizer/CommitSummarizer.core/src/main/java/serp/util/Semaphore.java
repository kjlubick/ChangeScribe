        ...
        implements Serializable
{
    ...
    /**
     * Construct the semaphore with an initial available count of <code>avaiable</code>.
     */
    ...
    /**
     * Down the semaphore's available count. If the count is at 0, this call will block until the semaphore is {@link #up}'d.
     */
    ...
    /**
     * Down the semaphore's available count. If the count is at 0, this call will block until the semaphore is {@link #up}'d or the given timeout elapses.
     *
