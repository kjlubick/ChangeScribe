        ...
        extends RefValueCollection
{
    ...
    /**
     * Construct a SoftCollection with the given interal collection. The internal collection will be cleared. It should not be accessed in any way after being given to this
