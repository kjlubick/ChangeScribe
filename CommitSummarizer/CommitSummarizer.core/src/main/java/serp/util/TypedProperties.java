...
/**
 * <p>
 * A specialization of the {@link Properties} map type with added convenience methods to retrieve and set options as primitive values. The internal representation of all data is
 * kept in string form.
 * </p>
 *
 * @author Abe White
        ...
        extends Properties
{
    ...
    /**
     * Overrides {@link Properties#setProperty(String,String)} to remove the key if the given value is <code>null</code>.
     *
