 ...
 *
 * <p>
 * Subclasses must define the {@link #createRefMapValue} method only. Expired values are removed from the map before any mutator methods; removing before accessor methods can lead
 * to {@link ConcurrentModificationException}s. Thus, the following methods may produce results which include key/value pairs that have expired:
 * <ul>
 ...
 *
 * <p>
 * By default, all methods are delegated to the internal map provided at construction. Thus, the hashing algorithm, ordering, etc of the given map will be preserved. Performance is
 * similar to that of the internal map instance.
 * </p>
 *
 * @author Abe White
 */
        ...
        implements RefMap
{
    ...
    /**
     * Construct a RefValueMap with the given interal map. The internal map will be cleared. It should not be accessed in any way after being given to this constructor; this map
     * will 'inherit' its behavior, however. For example, if the given map is a {@link LinkedHashMap}, the {@link #values} method of this map will return values in insertion order.
     */
    ...
    static interface RefMapValue
    {
        ...
        /**
         * Cause this instance to return <code>false</code> to all future {@link #isValid} calls.
         */
