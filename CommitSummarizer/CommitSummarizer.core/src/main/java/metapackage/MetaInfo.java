...
public class MetaInfo {
    ...
    /*
     * public static String get2KB(int i){ File projectDir = new File (srcDir, folderName); if (!projectDir.exists()) projectDir.mkdir(); inFile2K = new File (projectDir,
     * version[i] + "2KB.rub").getAbsolutePath(); return inFile2K; }
     * 
     * public static String getDelta(int i){ File projectDir = new File (srcDir, folderName); if (!projectDir.exists()) projectDir.mkdir(); deltaFile = new File (projectDir,
     * version[i] + "delta.rub").getAbsolutePath(); return deltaFile; }
     */
