...
public class FilesChangedListDialog extends TitleAreaDialog {
    ...
    private Composite createMessageAndPersonArea(Composite container) {
        ...
        /*
         * toolkit.createLabel(personArea, "Author: ").setForeground(toolkit.getColors().getColor(IFormColors.TB_TOGGLE)); setAuthorText(toolkit.createText(personArea, null));
         * getAuthorText().setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER); getAuthorText().setLayoutData(GridDataFactory.fillDefaults().grab(true, false).create());
         * if (git.getRepository() != null && git.getRepository().getRepositoryState().equals(RepositoryState.CHERRY_PICKING_RESOLVED)) { getAuthorText().setEnabled(false); }
         * 
         * toolkit.createLabel(personArea, "Committer").setForeground(toolkit.getColors().getColor(IFormColors.TB_TOGGLE)); setCommitterText(toolkit.createText(personArea, null));
         * getCommitterText().setLayoutData(GridDataFactory.fillDefaults().grab(true, false).create()); if (getCommitter() != null) { getCommitterText().setText(getCommitter()); }
         */
