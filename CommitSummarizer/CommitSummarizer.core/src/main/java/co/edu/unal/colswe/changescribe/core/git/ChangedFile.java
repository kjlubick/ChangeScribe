...
public class ChangedFile implements Comparable {
    ...
    public String getChangeTypeToShow(boolean thirdPerson) {
        ...
        if (!thirdPerson && changeType.equals(TypeChange.UNTRACKED_FOLDERS.toString()) || !thirdPerson && changeType.equals(TypeChange.ADDED.toString()) || !thirdPerson
                && changeType.equals(TypeChange.UNTRACKED.toString())) {
            type = "ADD";
        } else if (thirdPerson && changeType.equals(TypeChange.UNTRACKED_FOLDERS.toString()) || thirdPerson && changeType.equals(TypeChange.ADDED.toString())
                || changeType.equals(TypeChange.UNTRACKED.toString())) {
            type = "ADDS";
