...
public class TypeStereotypeRules
{
    ...
    protected boolean checkForLargeClass() {
        final boolean rule1 = 0.2 * this.totalMethods.size() <= this.accessorMethods.size() + this.mutatorMethods.size()
                && this.accessorMethods.size() + this.mutatorMethods.size() <= 0.6666666666666666 * this.totalMethods.size();
