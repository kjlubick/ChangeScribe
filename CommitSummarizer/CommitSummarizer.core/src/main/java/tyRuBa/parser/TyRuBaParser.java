...
public class TyRuBaParser implements TyRuBaParserConstants {
    ...
    /**
     * Parse from a URL, add any facts and rules it defines into the rulebase, "rules". Any code which is generated during parsing (by #generate directives) is written to the
     * PrintStream "os".
     * 
     * The file may contain queries, (usually for debugging purposes). The results of these queries will be reported to the standard error device.
     */
    ...
    /**
     * Parse from a file, add any facts and rules it defines into the rulebase. Any code which is generated during parsing (by #generate directives) is written to the PrintStream
     * "os".
     * 
     * The file may contain queries, (usually for debugging purposes). The results of these queries will be reported to the standard error device.
     */
    ...
    /**
     * Compute the string from the image of a string literal, quotes already removed before calling this method.
     */
    ...
    /**
     * Auxiliary function for makeQuotedCode: snip of the first part of the string upto the next Variable.
     */
    ...
    /**
     * Auxiliary function for makeQuotedCode: snip of the first part of the string which matches a variable.
     */
    ...
    final private boolean jj_3R_20() {
        if (jj_scan_token(LANGLE))
            return true;
        Token xsp;
        xsp = jj_scanpos;
        if (jj_3R_25())
            jj_scanpos = xsp;
        if (jj_scan_token(RANGLE))
            return true;
        return false;
    }
    ...
    private static void jj_la1_0() {
        jj_la1_0 = new int[] { 0x4006000, 0x4006000, 0x7b0000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x800000, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x2000000, 0x0, 0xe0000000, 0x0, 0x8000000,
                0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x7b0000, 0x0, 0x0, 0x590000, 0x220000, 0x0, 0x1440, 0x0, 0x1440, 0x0, 0x1440, 0x0, 0x1440, 0x0, 0x0, 0x1440, };
    }

    private static void jj_la1_1() {
        jj_la1_1 = new int[] { 0x10400000, 0x10400000, 0x10000202, 0x400000, 0x10000, 0x32002a00, 0x20, 0x200, 0x0, 0x10000, 0x32002800, 0x2000000, 0x2000000, 0x32002800, 0x10000,
                0x10000002, 0x0, 0x10000002, 0x1, 0x100000, 0x2000000, 0x2000, 0x2000, 0x10000, 0x20000000, 0x20000000, 0x100000, 0x10000200, 0x8000, 0x10000, 0x10000200, 0x0,
                0x10000, 0xf0002800, 0x2800, 0xf0000000, 0x100, 0xd0000000, 0x10000, 0xf0002800, 0x110000, 0x110000, 0xf0002800, };
    }
    ...
    private static void jj_la1_2() {
        jj_la1_2 = new int[] { 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
                0x0, 0x0, 0x0, 0x0, 0x201, 0x0, 0x1, 0x0, 0x1, 0x0, 0x201, 0x0, 0x0, 0x201, };
    }
