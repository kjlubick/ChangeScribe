...
public abstract class PreparedStatement {
    ...
    /**
     * May throw a TyRuBaException if the templateVar is unknown or the value provided is of a type not acceptable for the context where the templateVar occurs.
     */
