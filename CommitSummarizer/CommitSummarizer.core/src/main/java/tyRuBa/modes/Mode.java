...
/**
 * A Mode is an object representing an abstract approximation of the number of results a query is expected to return.
 * 
...
public class Mode implements Cloneable {
    ...
    /**
     * return -1 if this expected to return less results than other return 0 if this expected to return same nr of results than other return 1 if this expected to return more
     * results than other
     */
    ...
    /**
     * What's the mode if in actuality more parameters are bound than in the declaration?
     */
