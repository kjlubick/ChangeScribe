...
abstract public class Type implements Cloneable, Serializable {
    ...
    /**
     * check if this type is equal to other, if not, throw TypeError if grow is true, than SubAtomicType and SubCompositeType can grow
     */
    ...
    /**
     * return a clone of this, making sure that each TVar is only cloned once
     */
