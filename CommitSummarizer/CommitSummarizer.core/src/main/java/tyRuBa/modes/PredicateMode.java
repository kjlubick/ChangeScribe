...
/**
 * A PredicateMode consists of a BindingList, a Mode and a flag toBeCheck. If toBeCheck is set, then each each RBComponent with this declared mode will be checked before inserting
 * into any rulebase.
 */
