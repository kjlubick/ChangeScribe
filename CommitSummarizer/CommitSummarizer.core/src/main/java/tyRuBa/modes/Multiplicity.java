...
/**
 * A Multiplicity object represents a kind of abstract number. There are three Multiplicities:
 *
 * - zero - one - many
 */
public abstract class Multiplicity implements Comparable {
    ...
    /**
     * Multiplicities are abstract numbers, so they can be multiplied with one another
     */
    public abstract Multiplicity multiply(Multiplicity other);

    /**
     * Multiplicities are abstract numbers, so they can be added to one another
     */
