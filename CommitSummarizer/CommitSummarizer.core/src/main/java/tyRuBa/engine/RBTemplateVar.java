...
/**
 * An RBTemplateVar is a vriable starting with a "!" in its name. These variables are used as part of the JDBC-like interface in the construction of "prepared" statements where
 * they serve as placeholders for values that need to be provide before the statement is executed.
 * 
 * Therefore, templateVars are a funny mix of behaviors of variable and constant.
 * 
 * At runtime they should not exist anymore and be replaced by constants. Yet for some aspects of type checking they work similar to (always bound) variables. They also support
 * substitution (but should be used only before execution).
 */
