...
/**
 * An RBModeSwitchExpression specifies different ways to evaluate an expression when different variables are bound during execution. Once a switch case has been determined, the
 * order of evaluation will not be rearranged. All RBModeSwitchExpressions should have been converted to their switch case expressions before insertion.
 */
