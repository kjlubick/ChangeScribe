...
/**
 * A ValidatorManager persists the Validators that indicate whether facts for a bucket are valid or not. In a FactBase the validators are referenced by their handles, so mappings
 * are implemented in the ValidatorManager that allow retrieval of a validator by giving its handle.
 * 
 * @category FactBase
 * @author riecken
 */
public interface ValidatorManager {
     ...
     *            the Validator
     * @param identifier
     *            an identifier for this validator
     */
     ...
     * 
     * @param validatorHandle
     *            the validator's handle
     */
     ...
     * 
     * @param identifier
     *            identifier for the validator to remove.
     */
     ...
     * 
     * @param identifier
     *            Identifier of validator to retrieve.
     */
     ...
     * 
     * @param validatorHandle
     *            handle for the validator whose identifier you want.
     */
