...
public abstract class ModedRuleBaseIndex implements PredInfoProvider {
    ...
    /**
     * return the rulebase corresponding to predID which allow for bindings and has the "best" mode of execution
     */
    ...
    /**
     * insert predicate information to the set of known predicates for each predicate modes in the predicate info, a new ModedRuleBase is created and inserted into the hash map
     */
    public abstract void insert(PredInfo p) throws TypeModeError;

    /**
     * typecheck r, then insert it in all of the rulebases corresponding to r's predID
     */
