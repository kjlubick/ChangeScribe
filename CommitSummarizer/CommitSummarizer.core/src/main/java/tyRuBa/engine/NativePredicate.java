...
/**
 * A NativePredicate is a predicate that uses java methods in its evaluation. There is an Implementation for each predicate mode that this predicate can be evaluated in.
 * NativePredicates should disappear before they are inserted into a Rulebase since they should have been "convertedToMode" into Implementations before insertion.
 */
public class NativePredicate extends RBComponent {
    ...
    /**
     * add a predicate mode to this native predicate along with the implementation for this mode
     */
