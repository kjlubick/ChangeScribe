...
public abstract class RBTerm implements Cloneable, Serializable, TwoLevelKey {
    ...
    /**
     * Turn a tyruba object into a Java Object. The default implementation wraps the term in an UppedTerm object.
     */
    public Object up() {
    ...
    /**
     * Determine wether this and other have the "same form". The frames are used to remember which variables are associated to eachother. Binding from left -> righ go in one frame
     * bindings from right to left in the other
     */
    ...
    /**
     * formHashCode: hashCode which ignores variable names (to be used together with sameform)
     */
    ...
    /**
     * Gets the integer value *if* this term *is* an RBJavaObject containing an Integer
     */
    public int intValue() {
    ...
    /**
     * Register in the ModeCheckContext that all variables in this term have become bound.
     */
