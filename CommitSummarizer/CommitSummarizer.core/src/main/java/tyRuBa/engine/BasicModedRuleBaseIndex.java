...
/**
 * A BasicModedRuleBaseIndex stores ModedRuleBaseCollections in a hashmap. The PredicateIdentifier of each ModedRuleBaseCollection is used as the key in the hashmap.
 */
public class BasicModedRuleBaseIndex extends ModedRuleBaseIndex {
    ...
    /**
     * Index of rulebases for particular predicates and modes. forms. Keys used for indexing are composed of the predicate name with arity of an expression and its predicate mode
     */
