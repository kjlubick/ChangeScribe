...
/**
 * An RBExistsQuantifier evalutes the same way as an RBPredicateExpression except that the quantified variables are treated as brand new variables inside the EXISTS expression. It
 * is used mostly inside NOT expressions.
 */
