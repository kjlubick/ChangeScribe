...
public abstract class QueryEngine {
    ...
    /**
     * Load a file from the default library directory (stored somewhere in the classpath
     */
    ...
    /**
     * Solve a query and return an enumeration of frames with bindings for the values in the query
     */
    ...
    /**
     * Shortcut to get "property" of an object stored as a fact. Returns null, if no such property for the object is in the db.
     * 
    ...
    /**
     * like getProperty, but convert result to an int (must be RBJavaObject with an Integer inside or will throw some nasty execeptions)
     */
