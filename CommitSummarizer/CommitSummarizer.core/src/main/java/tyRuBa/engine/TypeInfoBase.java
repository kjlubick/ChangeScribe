...
public class TypeInfoBase implements PredInfoProvider {
    ...
    /**
     * A database in which we will store facts that describe the type declarations so that user can write tyruba programs about their own types.
     * 
     * @codegroup metadata
     */
    MetaBase metaBase;
    ...
    /**
     * After this methos is called, from this point forward in time, metaData will be added to the metaBase
     * 
     * @codegroup metadata
     */
    ...
    public void addTypeConst(TypeConstructor t) {
        ...
        if (metaBase != null)
            metaBase.assertTypeConstructor(t);
    }
