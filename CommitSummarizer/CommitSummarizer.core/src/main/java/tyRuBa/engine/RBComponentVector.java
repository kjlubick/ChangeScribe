...
/**
 * This class was introduced into the TyRuBa impplementation to avoid long chains of nested RBComponents in case we are working with large collections of rules and facts.
 */
...
public class RBComponentVector {
    ...
    /**
     * Create an empty ComponentVector, try to save some memory by predicting its eventual size
     */
