...
public class Frame extends Hashtable {
    ...
    /**
     * Frame maintains a stack of rules that where applied to bind variables in this frame
     */
    ...
    /**
     * This is a call Frame. bodyresult comes from further evaluations in the body. copy new stuff from body into "this"
     */
