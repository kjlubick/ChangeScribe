...
/**
 * This is what you get when an Expression is Compiled. It is a little piece of machinery that takes an ElementSource of Frames as its input and produces an ElementSource of Frames
 * as its output.
 * 
 * A number of additional abstract subclasses provide specific ways to implement the run method depending on the mode.
 */
public abstract class Compiled {
    ...
    /**
     * All compiled Expressions must override at least one of run(ElementSource) or run(Object)
     */
    ...
    /**
     * Called by a client to start a compiled. Subclasses may overrride with an equivalent but more efficient version.
     */
