...
public class CachedRuleBase extends Compiled {
    ...
    /*
     * To make better use of memory use this "Soft" CacheEntry instead of CacheEntry seems to have only small impact on runtime performance! private class CacheEntry extends
     * java.lang.ref.SoftReference { FormKey key; CacheEntry(FormKey k,ElementCollector r) { super(r); key = k; } ElementCollector getCachedResult() { return
     * (ElementCollector)get(); } }
     */
