...
public class TestLogger {
    ...
    /**
     * A LogEntry collects information to be written out to the logfile. It is supposed to record information associated with some kind of event occurring in the code which has a
     * takes place over a given interval of time.
     * 
     * LogEntries are created by call the begin method on the logger. logentries will record the creation time (a log sequence number).
     * 
     * logentries are written by calling the "end" method. And they will record the time of the call as the time the process logged by this entry was completed.
     * 
     * The current implementation assumes that begin_end events of logentries are "nested" like this begin event 1 begin event 2 begin event 3 end event 3 end event 2 end event 1
     */
