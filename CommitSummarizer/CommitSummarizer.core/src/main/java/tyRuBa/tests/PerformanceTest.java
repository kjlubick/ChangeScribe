...
public class PerformanceTest {
    ...
    /*
     * Run as a scenario meaning that we are more interested in how this series of queries performs as a whole. So we do not want to perform gc in between each test and we do not
     * want to start/stop the clock in between each test, or perform IO operations between the tests to report results.
     */
