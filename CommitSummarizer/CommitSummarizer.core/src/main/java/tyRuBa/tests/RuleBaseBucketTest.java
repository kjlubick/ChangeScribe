...
public class RuleBaseBucketTest extends TyrubaTest {
    ...
    /**
     * A test designed to catch a particular bug in the ModedRuleBaseCollection. The bug surfaces when a new moded rulebase gets created on the fly after some of the rules that
     * were inserted ot the collection have been outdated.
     *
