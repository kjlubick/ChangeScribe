...
/**
 * An ElementCollector which allows duplicate Elements. Is more efficient than an ElementSetCollector because it does not keep track of the elments in a Set and does not verify
 * incoming elements for duplicates
 */
