 ...
 * @author cburns
 *
 *         Special Iterator class that iterates over a pair of iterators. I'm sure you can see the possibilities this opens, beyond just adding two Iterators together.
 */
