...
/**
 * A map ElementSource is an elementSource that walks through another elementSource and computes elements for another elementSource through an action. The resulting elementSource
 * consists of the non null results of the action aplied to the input elementSource
 */
final class MapElementSource extends ElementSource {
    ...
    public void print(PrintingState p) {
        ...
        p.print("Action= " + action.toString());
        p.newline();
        p.print("on =");
        p.indent();
        if (remaining == null)
