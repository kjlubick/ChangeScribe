 ...
 * 
 *         This class is only really useful for reducing memory overhead. It sure is a lot of work for one silly mapping :P
 */
...
public class OneMap implements Map, Serializable {
    ...
    public Object get(Object key) {
        return ((key == null && this.key == null) || (key != null && key.equals(this.key))) ? value : null;
    }
