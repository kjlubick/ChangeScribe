...
/**
 * Merges elements from a number of element sources. An element source is called upon by the element Merger when it needs to produce a new element.
 * 
 * The element sources themselves are elements produced by an element source.
 * 
 * ElementCollectors work in a lazy way and will not request element sources to produce an element until the elements in the ElementCollector are being accessed.
 */
