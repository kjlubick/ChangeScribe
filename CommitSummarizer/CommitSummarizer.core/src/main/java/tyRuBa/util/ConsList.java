...
/**
 * A ConsList is a linked list type structure, but it can only be manipulated in side-effect-free manner. A functional operation "cons" is the ony way to add elements. The contents
 * of a ConsList once constructed cannot be changed.
 */
