...
public class AtomicChange {
    ...
    public static AtomicChange makeConditionalChange(char typ, String condition, String ifBlockName, String elseBlockName, String typeFullName) {
        ...
        /*
         * AtomicChange(typ=='A'?ChangeTypes.ADD_TYPEINTYPE: ChangeTypes.DEL_TYPEINTYPE, params); return new AtomicChange(typ=='A'?ChangeTypes.ADD_CONDITIONAL:
         * typ=='D'?ChangeTypes.DEL_CONDITIONAL: Chan, params);
         */
